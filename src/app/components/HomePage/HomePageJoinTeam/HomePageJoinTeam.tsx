  ...
  return (
    <div className='w-full relative md:my-24 my-8 h-[480px]'>
        ...
        <div className='w-full max-w-[1280px] mx-auto absolute left-0 right-0 tob-0 bottom-0 h-full'>
            <div className='px-8 flex justify-center items-center flex-col absolute right-0 left-0 md:left-auto mx-auto top-[50%] translate-y-[-50%] bg-[#0059DF] w-[95%] md:w-[40%] h-[80%] md:h-[300px] rounded-3xl'>

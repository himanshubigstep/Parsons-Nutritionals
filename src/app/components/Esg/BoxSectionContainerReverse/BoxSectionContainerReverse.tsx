  ...
  return (
    <div className="w-full max-w-[1280px] mx-auto md:py-24 py-8">
      <div className="w-full flex flex-col md:flex-row justify-center items-center">
          <div className="w-[95%] md:w-[45%] md:h-[520px] md:rounded-[3.75rem] rounded-lg landscape:rounded-lg z-10">
            <img
              className="w-full h-full object-cover md:rounded-[3.75rem] rounded-lg landscape:rounded-lg ml-0 md:ml-[10%] mt-0 md:mt-[-10%]"
              src={esgPageDataImage}
              alt=""
            />
          </div>
          <div className="w-[95%] md:w-[55%] h-full mt-0 md:h-[520px] bg-white dark:bg-black dark:border-[1px] dark:border-gray-700 md:rounded-[3.75rem] rounded-lg landscape:rounded-lg flex flex-col md:py-8 md:px-8 p-12 justify-center">

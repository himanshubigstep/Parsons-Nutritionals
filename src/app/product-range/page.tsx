...
const ProductRange = () => {
    ...
    const handleCategorySelect = (category: string) => {
      ...
      // Filter product data based on the selected category
  ...
  return (
    <main className="flex min-h-screen flex-col items-center bg-white">
        ...
        <div className='w-full max-w-[1280px] mx-auto relative flex flex-col md:flex-row gap-8 py-16'>
            <ProductCategory productData={productData} onCategorySelect={handleCategorySelect} selectedCategory={selectedCategory} />
            <ProductListcategory productData={filteredProductData} selectedCategory={selectedCategory} />
        </div>
    </main>
  )
}

    ...
    return (
        <div className="relative w-full md:w-full max-w-full mx-auto pt-8">
            ...
            <div className='md:absolute left-0 right-0 top-0 bottom-0 w-full max-w-[1280px] mx-auto'>
                <div className="px-8 py-8 sm:px-16 sm:py-16 bg-[#0059DF] md:absolute bottom-0 right-0 md:rounded-tl-[30px] sm:rounded-tl-[60px] rounded-tr-none rounded-b-none w-full sm:w-[38.375rem] h-auto sm:h-[28.688rem]  flex flex-col justify-center">

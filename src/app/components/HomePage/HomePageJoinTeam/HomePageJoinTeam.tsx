...
const HomePageJoinTeam = ({homePageDataValue}: {homePageDataValue:any}) => {
  ...
  return (
    <div className='w-full relative my-24 h-[480px]'>
        <img src={`${mediaUrl}${JoinTeamData?.media?.data?.attributes?.formats?.large?.url}`} alt="Join Team" className='w-full h-full object-cover absolute left-0 right-0 tob-0 bottom-0' />

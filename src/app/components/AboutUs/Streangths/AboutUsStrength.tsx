...
const AboutUsStrength = ({ aboutUsPageDataValue }: { aboutUsPageDataValue: any }) => {
    ...
    return (
        <div className='max-w-[1280px] mx-auto w-full px-8 py-8 flex justify-center items-center mb-8 our-strength'>
            <div className='w-[45%] h-[640px] rounded-3xl bg-black px-8 py-8 mr-[-8%] z-10 flex flex-col gap-8 items-start our-strength-img'>
            ...
            <div className='w-[55%] rounded-3xl bg-white shadow-[0px_1px_2px_rgba(16,_24,_40,_0.05)] our-strength-content'>

...
const BannerSubContainer: React.FC<BannerSubContainerProps> = ({ BannerContainerData }) => {
  ...
  return (
    <div className='banner-sub-container md:absolute md:mt-0 mt-[-5rem] left-0 right-0 md:top-[80%] top-1/2 w-[680px] mx-auto bg-white flex justify-center items-center flex-col p-[2px] rounded-2xl'>
